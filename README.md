...
|--------------|-------------|------|
| 🌐 **Windows Logging for SOC – Security Investigation** |  SOC-style investigation of a Windows endpoint analyzing Event Viewer, Sysmon, and PowerShell logs. Detected brute-force attacks, malware downloads, persistence, and C2 communication. Demonstrates full attack chain reconstruction and MITRE ATT&CK mapping. | [View Project](https://github.com/Lucas-Cyber-Security/Windows-Logging-for-SOC-Log-Analysis-Investigation) |
